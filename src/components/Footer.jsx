    ...
    <>
        ...
        <div className="footer__container">
            <div className="footer__logo">
               ...
               <div>
                    <a className="nav__link bottom" href="#features">Features</a>
                    <a className="nav__link bottom"  href="#testimonial">Testimonials</a>
                    <a className="nav__link bottom"  href="#pricing">Pricing</a>
               </div>
            </div>
