import avatar4 from '../assets/image/avatars/avatar-4.png'
import avatar3 from '../assets/image/avatars/avatar-3.png'
import avatar2 from '../assets/image/avatars/avatar-2.png'
import avatar5 from '../assets/image/avatars/avatar-5.png'
import avatar1 from '../assets/image/avatars/avatar-1.png'
const Testimonial = () => {
  return (
    <>
            ...
            <div className="testimonial__wrapper">
                <div className="testimonial__card">
                    ...
                    <div className="testimonial__info">
                        ...
                        <img src= {avatar1} alt="Sheryl Berge" />
                    </div>
                </div>
                <div className="testimonial__card">
                    <i className='bx bxs-quote-alt-left blockquote__icon'></i>
                    ...
                    <div className="testimonial__info">
                        ...
                        <img src= {avatar4} alt="Sheryl Berge" />
                    </div>
                </div>
                <div className="testimonial__card">
                    <i className='bx bxs-quote-alt-left blockquote__icon'></i>
                    ...
                    <div className="testimonial__info">
                        ...
                        <img src= {avatar5} alt="Sheryl Berge" />
                    </div>
                </div>
                <div className="testimonial__card">
                    <i className='bx bxs-quote-alt-left blockquote__icon'></i>
                    ...
                    <div className="testimonial__info">
                        ...
                        <img src= {avatar2} alt="Sheryl Berge" />
                    </div>
                </div>
                <div className="testimonial__card">
                    <i className='bx bxs-quote-alt-left blockquote__icon'></i>
                    ...
                    <div className="testimonial__info">
                        ...
                        <img src= {avatar3} alt="Sheryl Berge" />
                    </div>
                </div>
                <div className="testimonial__card">
                    <i className='bx bxs-quote-alt-left blockquote__icon'></i>
